...
Так же приложение развернуто на предоставленной машине от Школы Бэкенд Разработки яндекса по адресу https://zones-1883.usr.yandex-academy.ru/ согласно техническому заданию. Спецификация находится в файле <code>openapi.yml</code> текущего репозитория.
